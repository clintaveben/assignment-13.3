...
#Q) a. Visualize the correlation between all variable in a meaningful
# way, clear representation of correlations. Find out top 3 reasons 
# for having more crime in a city.
...
#Q) b. What is the difference between covariance and correlation,
